...
namespace Firely.Fhir.Validation
{
    ...
    public static class AssertionValidators
    {
        ...
        /// </summary>
        public static ResultReport Validate(this IAssertion assertion, IEnumerable<ROD> input, string groupLocation, ValidationContext vc)
        ...
        /// </summary>
        public static ResultReport Validate(this IAssertion assertion, ROD input, ValidationContext vc)
            => assertion.ValidateOne(input.asScopedNode(), vc, new ValidationState());

        private static ROD asScopedNode(this ROD node) => node is ScopedRod ? node : new ScopedRod(node);
        ...
        internal static ResultReport ValidateMany(this IAssertion assertion, IEnumerable<ROD> input, string groupLocation, ValidationContext vc, ValidationState state)
        {
            ...
            static ResultReport repeat(IValidatable assertion, IEnumerable<ROD> input, ValidationContext vc, ValidationState state)
            {
        ...
        internal static ResultReport ValidateOne(this IAssertion assertion, ROD input, ValidationContext vc, ValidationState state) =>
            assertion switch
            {
