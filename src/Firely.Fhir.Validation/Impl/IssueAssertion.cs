...
#pragma warning restore CS0618 // Type or member is obsolete
{
    ...
    /// <summary>
    /// A position of the error in the original json/xml document, if provided. 
    /// </summary>
    internal IPositionInfo? PositionInfo { get; private set; }

    /// <summary>
    /// Information which validator is source of the Issue
    /// </summary>
    ...
    public JToken ToJson()
    {
        ...
        {
            props.Add(new JProperty("line", PositionInfo.LineNumber));
            props.Add(new JProperty("column", PositionInfo.LinePosition));
        }
