...
namespace Firely.Fhir.Validation.Compilation.Tests
{
    public class StructureDefinitionCorrectionsResolverTests
    {
        ...
        public async Task ResourceIdCorrectionTest()
        {
            ...
            await context.RunTest(correctingResolver, "http://hl7.org/fhirpath/System.String", "string");
        }
        ...
        {
            var context = new BundleCorrectionTestContext("hl7.fhir.r4.core@4.0.1");
            var correctingResolver = new StructureDefinitionCorrectionsResolver(context.ProjectResolver);

            await context.RunTest(correctingResolver, ["bdl-3a", "bdl-3b", "bdl-3c", "bdl-3d", "bdl-15"]);
        }
    }
}