...
public class BundleCorrectionTestContext : TestContext
{
    ...
    {
        var bundle = await correctingResolver.TryResolveByCanonicalUriAsync(BUNDLE_URL);
    ...
    private static void check(ResolverResult result, List<string> constraints, bool diffShouldContainConstraints)
    {
        result.Success.Should().BeTrue();
        result.Value.Should().NotBeNull();
        result.Value.Should().BeOfType<StructureDefinition>();
