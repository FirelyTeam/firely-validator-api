...
#pragma warning restore IDE0052 // I'd like to keep the output handy when I need it
        ...
        public void InjectMetaProfileTest()
        {
            ...
            result = schema!.Validate(bundle.ToPocoNode(), context);
            result.Result.Should().Be(ValidationResult.Success);

            static Canonical[] metaCallback(string location, Canonical[] originalUrl, PocoNode input, ValidationSettings vc)
        ...
        public void ValidateExtensionTest()
        {
            ...
            var result = schema!.Validate(patient.ToPocoNode(), context);
            ...
            result = schema!.Validate(patient.ToPocoNode(), context);
