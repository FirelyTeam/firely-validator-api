...
namespace Firely.Fhir.Validation.Tests
{
    internal class PatternValidatorData : BasicValidatorDataAttribute
    {
        public override IEnumerable<object?[]> GetData()
        {
            ...
            yield return new object?[]
            {
                new PatternValidator(PocoNode.ForAnyPrimitive("test")),
            ...
            yield return new object?[]
            {
                new PatternValidator(PocoNode.ForAnyPrimitive(true)),
            ...
            yield return new object?[]
            {
                new PatternValidator( PocoNode.ForAnyPrimitive("20190905")),
