    ...
    public class ReferenceTests
    {
        private static readonly ElementSchema _schema = new("http://hl7.org/fhir/StructureDefinition/Patient",
                new Children(true,
                    ...
                    ("contained", new ReferenceAssertion("http://hl7.org/fhir/StructureDefinition/Resource")),
                    ("other", new ReferenceAssertion("http://hl7.org/fhir/StructureDefinition/Reference"))
                ),
