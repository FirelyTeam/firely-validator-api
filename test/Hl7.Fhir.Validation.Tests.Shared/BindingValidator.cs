...
namespace Hl7.Fhir.Validation
{
    ...
    {
        public static BindingValidator.BindingStrength ToSchemaBindingStrength(this BindingStrength strength) => (BindingValidator.BindingStrength)(int)strength;

        public static BindingValidator ToValidatable(this ElementDefinition.ElementDefinitionBindingComponent binding, string? context = null)
        {
            ...
            return uri != null
                ? new BindingValidator(uri, binding.Strength.Value.ToSchemaBindingStrength(), abstractAllowed: true, context)
